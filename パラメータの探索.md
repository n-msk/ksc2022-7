...
<img src="prev_fitting.png" alt="prev_fitting" width="600" height="600">
    
ラーモア振動の周期は $T = 2353 \pm 194.1 \textrm{ns}$ であり，推定される磁束密度は $3.14 \pm 0.25 \textrm{mT}$.
    
かけた値 $2 \textrm{mT}$は $4\sigma$ くらいのところにいる．
